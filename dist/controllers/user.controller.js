...
var UserController = /** @class */ (function () {
     ...
     * @public
     */
    UserController.createUserAccount = function (req, res, next) {
            ...
            return __generator(this, function (_b) {
                try {
                    ...
                    User_1.default.create({
                        ...
                        .then(function (user) {
                        logger_1.default.info("User Account successfully created");
                        ...
                        .catch(function (err) {
                        logger_1.default.info("Account already exist", err.message);
                    ...
                    logger_1.default.info("Internal server error", err.message);
     ...
     * @public
     */
    UserController.createAdminAccount = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, firstName, lastName, email, password;
            return __generator(this, function (_b) {
                try {
                    ...
                    User_1.default.create({
                        ...
                        .then(function (user) {
                        logger_1.default.info("Admin Account successfully created");
                        return res.status(httpStatus.CREATED).send({
                            message: "Account successfully created",
                            status: "created",
                            status_code: httpStatus.CREATED,
