            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, jwt_1.verifyRefreshToken(refreshToken)];
                    case 1:
                        id = (_a.sent()).id;
                        redis_connection_1.redisClient.DEL(id, function (err, val) {
                            if (err)
    ...
    AuthController.authenticate = function (req, res, next) {
        ...
        try {
            ...
            User_1.default.findOne({ email: email }).then(function (user) {
                ...
                user.comparePassword(password_1, function (err, isMatch) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, jwt_1.signAccessToken({
                                        id: user.id,
                                        role: user.role,
                                    })];
                            case 1:
                                accessToken = _a.sent();
                                return [4 /*yield*/, jwt_1.signRefreshToken({
                                        id: user.id,
                                        role: user.role,
                                    })];
                            case 2:
                                ...
                                return [2 /*return*/, res.status(httpStatus.OK).send({
                                        ...
                                        results: [{ user: user.toJSON(), accessToken: accessToken, refreshToken: refreshToken }],
                                    })];
                        }
                    });
                }); });
